        <div class="row">
          <div class="col s12 m9">
            <h3 class="black-text">Tanggapan</h3>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn modal-trigger blue" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Detail</a>  <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a></td>
