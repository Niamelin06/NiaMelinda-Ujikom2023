          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#user"><img class="circle" src="../img/niaa.jpg"></a>
                      <a href="#name"><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a>
                  </div>
              </li>
              <li><a href="index.php?p=dashboard">Dashboard</a>
              <li><a href="index.php?p=registrasi">Registrasi</a>
              <li><a href="index.php?p=pengaduan">Respon</a>
              <li><a href="index.php?p=respon">Laporan telah di tanggapi</a></li>
              <li><a href="index.php?p=user">Registrasi Admin/Petugas</a>
              <li><a href="index.php?p=laporan">Laporan</a>
              <li>
                  <div class="divider"></div>
              </li>
              <li><a class="waves-effect" href="../index.php?p=logout">Logout</a>
          </ul>
